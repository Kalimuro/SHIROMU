...
vh = {"YouTube": "youtube.com/user/",
      "Twitch": "twitch.tv/", "Pornhub": "rt.pornhub.com/users/", "Red Tube": "ru.redtube.com/users/",
      "Xvideos": "www.xvideos.com/profiles/"}

games = {"Steam": "steamcommunity.com/id/", "Ubisoft": "club.ubisoft.com/profile/",
         "Chess": "www.chess.com/ru/member/", "Xbox": "account.xbox.com/profile?gamertag=",
         "Warface": "wfts.su/profile/",
    ...
    for key, site in dict.items():
        ...
        try:
            ...
            if r.status_code == 200:
                print(Fore.BLUE + "Найдено в:  " + key + ": " + url)
            else:
                print(Fore.BLUE + key + " Не найдено :(")
        except:
            print(Fore.BLUE + "Ошибка :(" + key)
